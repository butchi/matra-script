window.matraScript = // @generated by Peggy 4.0.2.
//
// https://peggyjs.org/
(function() {
  "use strict";
...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { Package: peg$parsePackage };
  var peg$startRuleFunction = peg$parsePackage;
  ...
  var peg$e0 = peg$literalExpectation("matra", false);
  ...
  var peg$f1 = function(tag, prop, body) {
    var tagProp = {}
  ...
  var peg$f10 = function(tag) {
      return tag.join("")
    };
  var peg$f11 = function(map) {
      return map
    };
  ...
  var peg$f15 = function(key, val) {
    return [key, val]
  };
  var peg$f16 = function(str) {
    return str.join("")
  };
  var peg$f17 = function(xStr, yStr) {
  ...
  function peg$parseBodyExpression() {
    var s0, s1, s2, s3, s4, s5, s6;
